...
test('decodeHeader(): throws an error with an invalid header', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/512x478x24.jpg');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
...
test('decodeIHDR(): can read a valid PNG IHDR chunk', async (t) => {
  let image_data = await fs.readFile('./test/image/assets/512x478x24.png');
...
test('decodePixels(): can decode pixel data', async (t) => {
  ...
  image_data = await fs.readFile('./test/image/assets/150x300x8-MANY-CHUNKS.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/4x4x8-RGB-MAGENTA.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/4x4x8-RGB-MAGENTA-ZOPFLI.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/4x4xGRAY-ZOPFLI.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/4x4xRGB-BLACK-WHITE.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 16);
  pixel = image.getPixel(0, 0);
  ...
  image_data = await fs.readFile('./test/image/assets/111x115x8-PHYS-GAMA.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/150x300x8-COMPRESSED.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 45000);
  pixel = image.getPixel(0, 0);
  ...
  image_data = await fs.readFile('./test/image/assets/150x300x8-NEW.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/1015x1021x8-transparent.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/ucnv-png-glitch-none.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  ...
  image_data = await fs.readFile('./test/image/assets/ucnv-png-glitch-up.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3279360);
  pixel = image.getPixel(0, 0);
  ...
  image_data = await fs.readFile('./test/image/assets/ucnv-png-glitch-paeth.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3279360);
  pixel = image.getPixel(0, 0);
  ...
  image_data = await fs.readFile('./test/image/assets/ucnv-png-glitch-average.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3279360);
  pixel = image.getPixel(0, 0);
  ...
  image_data = await fs.readFile('./test/image/assets/ucnv-png-glitch-sub.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3279360);
  pixel = image.getPixel(0, 0);
...
test('getPixel(x, y): can get a specific pixel of an image (4x4, RGB, 8 bit, Zopfli)', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/4x4x8-RGB-MAGENTA-ZOPFLI.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  let pixel = image.getPixel(0, 0);
  t.deepEqual(pixel, [254, 0, 1, 255]);
...
test('PngSuite - Basic Formats - basn0g01 - black & white', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn0g01.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
...
test('PngSuite - Basic Formats - basn0g02 - 2 bit (4 level) grayscale', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn0g02.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Basic Formats - basn0g04 - 4 bit (16 level) grayscale', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn0g04.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Basic Formats - basn0g08 - 8 bit (256 level) grayscale', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Basic Formats - basn2c08 - 3x8 bits rgb color', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
...
test('PngSuite - Basic Formats - basn3p08 - 8 bit (256 color) paletted', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn3p08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Basic Formats - basn4a08 - 8 bit grayscale + 8 bit alpha-channel', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn4a08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 2048);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Basic Formats - basn6a08 - 3x8 bits rgb color + 8 bit alpha-channel', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/basn6a08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 4096);
  const pixel = image.getPixel(0, 0);
...
// http://www.schaik.com/pngsuite/pngsuite_bas_png.html
test('PngSuite - Interlacing', async (t) => {
  let image_data = null;
  let image = null;
  let pixel = null;

  // basi0g01 - black & white
  image_data = await fs.readFile('./test/image/assets/PngSuite/basi0g01.png');
  image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f00n0g08 - grayscale, no interlacing, filter-type 0', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f00n0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f00n2c08 - color, no interlacing, filter-type 0', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f00n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f01n0g08 - grayscale, no interlacing, filter-type 1', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f01n0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f01n2c08 - color, no interlacing, filter-type 1', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f01n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f02n0g08 - grayscale, no interlacing, filter-type 2', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f02n0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f02n2c08 - color, no interlacing, filter-type 2', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f02n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f03n0g08 - grayscale, no interlacing, filter-type 3', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f03n0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f03n2c08 - color, no interlacing, filter-type 3', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f03n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f04n0g08 - grayscale, no interlacing, filter-type 4', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f04n0g08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f04n2c08 - color, no interlacing, filter-type 4', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f04n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Image Filtering - f99n0g04 - bit-depth 4, filter changing per scanline', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/f99n0g04.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 1024);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Zlib Compression - z00n2c08 - color, no interlacing, compression level 0 (none)', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/z00n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Zlib Compression - z03n2c08 - color, no interlacing, compression level 3', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/z03n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Zlib Compression - z06n2c08 - color, no interlacing, compression level 6 (default)', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/z06n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Zlib Compression - z09n2c08 - color, no interlacing, compression level 9 (maximum)', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/z09n2c08.png');
  const image = ImagePNG.fromFile(image_data);
  image.decodePixels();
  t.is(image.pixels.length, 3072);
  const pixel = image.getPixel(0, 0);
...
test('PngSuite - Corrupted Files - xs2n0g01 - signature byte 2 is a "Q"', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/xs2n0g01.png');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
  }, { message: 'Missing or invalid PNG header.' });
});
...
test('PngSuite - Corrupted Files - xs4n0g01 - signature byte 4 lowercase', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/xs4n0g01.png');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
  }, { message: 'Missing or invalid PNG header.' });
});
...
test('PngSuite - Corrupted Files - xs7n0g01 - 7th byte a space instead of control-Z', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/xs7n0g01.png');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
  }, { message: 'Missing or invalid PNG header.' });
});
...
test('PngSuite - Corrupted Files - xcrn0g04 - added cr bytes', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/xcrn0g04.png');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
  }, { message: 'Missing or invalid PNG header.' });
});
...
test('PngSuite - Corrupted Files - xlfn0g04 - added lf bytes', async (t) => {
  const image_data = await fs.readFile('./test/image/assets/PngSuite/xlfn0g04.png');
  t.throws(() => {
    ImagePNG.fromFile(image_data);
  }, { message: 'Missing or invalid PNG header.' });
});
